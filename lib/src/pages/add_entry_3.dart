...
class AddEntry3 extends StatefulWidget {
  final NewJournalEntry newEntry;

  const AddEntry3({super.key, required this.newEntry});

  @override
  State<AddEntry3> createState() => _AddEntry3();
}

class _AddEntry3 extends State<AddEntry3> {
  ...
  void nextView(BuildContext context) {
    ...
    //load next view
    Navigator.of(context).push(Routes.createHorizontalRoute(AddEntry1(
